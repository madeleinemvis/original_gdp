...
def main(source_urls: [str]):
    ...
    scraped_data[alt_url] = Scraper.get_data_from_source(alt_url)
    print("Similar Doc:", analyser.check_similarity(scraped_data[start_url].tokens))
    print("Non-similar doc:", analyser.check_similarity(scraped_data[alt_url].tokens))
